  ...
  const navigate = useNavigate(); // Hook to handle navigation
   ...
   useEffect(() => {
    const fetchStates = async () => {
      try {
        const response = await axios.get('https://traveleasy-backend.onrender.com/states');
  ...
  useEffect(() => {
    if (departureState) {
      const fetchTerminals = async () => {
        try {
          const response = await axios.get(`https://traveleasy-backend.onrender.com/terminals/${stateId}`);
  ...
  useEffect(() => {
    if (terminal) {
      const fetchDestinations = async () => {
        try {
          const response = await axios.get(`https://traveleasy-backend.onrender.com/terminals`);
