...
const Home = () => {
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    <div className="absolute inset-0 flex items-center justify-start text-start ml-24 p-4">
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    <div className="absolute inset-0 flex items-center justify-start text-start p-4">
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    <div className="absolute inset-0 block items-center justify-start text-start p-4">
