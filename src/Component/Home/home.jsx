...
const Home = () => {
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    <div className="sm-d-none absolute inset-0 flex items-center lg:justify-start lg:text-start sm:justify-center sm:text-center lg:ml-24 p-4">
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    <div className="sm-d-none absolute inset-0 flex items-center lg:justify-start lg:text-start sm:justify-center sm:text-center p-4">
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    <div className="sm-d-none absolute inset-0 block items-center justify-start text-start sm:justify-center sm:text-center p-4">
    ...
    {/* Form container */}
    <div className="lg:absolute lg:top-0 lg:right-0 lg:w-1/3 mx-auto mb-2 mt-2 bg-white bg-opacity-80 rounded-lg shadow-lg md:mt-8 mr-4 md:mr-8 z-10 lg:z-auto">
