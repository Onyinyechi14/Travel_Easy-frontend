...
const Home = () => {
  ...
  <div className="relative overflow-hidden carousel-height">
    ...
    {/* Form container */}
    <div className="absolute top-0 right-0 lg:w-1/3 mx-auto mb-2 mt-2 bg-white bg-opacity-80 rounded-lg shadow-lg md:mt-8 mr-4 md:mr-8 z-10 sm:static sm:mt-20 sm:transform-none">
